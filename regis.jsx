         ...
         <form id="contact-form" role="form" onSubmit={onSubmits}>
             <div className="controls">
                 ...
                 <div  className="row">
                     ...
                     <div className="col-md-4">
                     <div className="form-group"> <label for="form_Gender">Gender *</label> <select id="form_gender" name="gender" className="form-control" required="required" data-error="Please specify your gender." value={fullName.Gender} onChange={inputEvent}>
                     ...
                     <div className="col-md-4">
                         <div className="form-group"> <label for="form_admissionyear">Year of admission *</label> <input id="form_admissionyear" type="month" name="year_of_admission" className="form-control" placeholder="Please enter your year of admission " required="required" data-error="Admission year is required." value={fullName.admiYr} onChange={inputEvent} /> </div>
                     </div>
                 </div>
                 <div className="row">
